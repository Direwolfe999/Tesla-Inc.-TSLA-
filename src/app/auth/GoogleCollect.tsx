  ...
  return (
    <div className="w-full max-w-[450px] bg-white dark:bg-[#1f1f1f] rounded-[24px] border border-[#e0e0e0] dark:border-white/10 shadow-sm mx-auto overflow-hidden animate-in fade-in zoom-in-95 duration-300">
      ...
      <div className="h-[4px] w-full bg-gray-100 dark:bg-white/5 relative overflow-hidden">
        {loading && (
          <div className="absolute inset-0 bg-[#1a73e8] animate-pulse w-full">
            <div className="h-full w-1/3 bg-[#4285F4] animate-[progress_1.5s_infinite_linear]"></div>
          </div>
        )}
      </div>
      ...
      <div className="p-8 md:p-10 pt-6">
        ...
        {step === 2 && (
          ...
          >
            <div className="w-5 h-5 rounded-full bg-[#1D6350] flex items-center justify-center text-[10px] text-white uppercase font-bold">
              {email ? email[0] : "U"}
            </div>
        ...
        <form onSubmit={handleStepChange}>
          <div className="group relative mb-10">
            ...
            {step === 2 && (
              ...
              >
                <Icon
                  icon={showPass ? "tabler:eye-off" : "tabler:eye"}
                  width="20"
                />
              </button>
            )}
